...
## 2026-08-02 06:11:10.209 — coupon_field_shown + 5 more created

- **kind:** schema
- **spec:** 06_unseen_data
- **detail:** Instrumentation Agent · approved by unnamed reviewer · 5,363 events loaded across 6 tables
- **trace:** https://cloud.langfuse.com/trace/3b79af23-5986-4a04-9ad4-99b16d6621d6
- **tables:** coupon_field_shown (2,100 rows), coupon_entered (848 rows), coupon_applied (580 rows), discount_shown (580 rows), checkout_with_coupon (987 rows), coupon_rejected (268 rows)

## 2026-08-02 06:11:10.155 — context v1.9

- **kind:** context
- **spec:** 06_unseen_data
- **detail:** +10 new entries · 3 existing definitions superseded · convention:data_hygiene, convention:envelope, convention:sessionization
- **contradiction surfaced:** an existing definition was replaced
- **trace:** https://cloud.langfuse.com/trace/3b79af23-5986-4a04-9ad4-99b16d6621d6
- **entities:** convention:data_hygiene, convention:envelope, convention:sessionization, metric:coupon_apply_rate, metric:coupon_conversion_lift, metric:coupon_margin_cost, spec:06_promo_coupon, table:checkout_with_coupon, table:coupon_applied, table:coupon_entered, table:coupon_field_shown, table:coupon_rejected, table:discount_shown
