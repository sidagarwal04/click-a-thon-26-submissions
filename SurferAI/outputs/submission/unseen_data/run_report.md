# CUJ 1 Ingestion Run Report — `unseen_data`

- **Target Table:** `promo_coupon_checkout`
- **Execution Timestamp:** `2026-08-02T06:01:46.784330+00:00`
- **Trace URL:** https://us.cloud.langfuse.com/project/cmpwirpg5009oad0esljbiev9/traces/2b64146687135c4177f914ed280ad8b4
- **Run Mode:** `live_run`
...
12. **context_agent::write_table_semantics** (context_agent): wrote table description, concepts, and embedding (0 dims) for promo_coupon_checkout into chDB table_semantics (v5)
