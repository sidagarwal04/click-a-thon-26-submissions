#!/usr/bin/env bash
#
# Installer for the `design-ch-schema` skill.
#
...
mkdir -p "$DEST"
# Copy the skill payload but never the installer/readme/zip artifacts themselves.
...
echo "  2. Optionally export any non-default settings before running:"
echo "       export CH_TARGET_REPO=https://github.com/<you>/<repo>.git"
echo "       export CH_TARGET_BRANCH=main"
echo "       export CH_DATABASE=analytics"
echo "       export CH_HOST=... CH_USER=... CH_PASSWORD=..."
echo "  3. Trigger it, e.g.: \"onboard product in clickhouse\""
