cccccbrdinbdcbdtfhfhbucievljvubtnuvghtkrdiuj
# Watcher Griffin
...
**http://metric-sherlock.cricheroes.io/**

Shows the operations screen, an incident diagnosis, the ruled-out evidence, and a number
being verified against its query — plus the dataset switcher to the unseen incident dataset.

## Demo Video

**https://drive.google.com/file/d/15vSnlouf0WoKJ1nrQWQIdOgVoZjCvZUE/view?usp=drive_link**

## Pitch deck PDF

**https://drive.google.com/file/d/1cznCp7idpbc5foqXBpeYwpMse3etCvYg/view?usp=drive_link**
