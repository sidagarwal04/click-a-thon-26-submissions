...
import type { AnalyticsBlock, TMessage, TMessageContentParts } from 'librechat-data-provider';
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <div className="flex min-h-[20px] max-w-full flex-grow flex-col gap-0">
            {Array.isArray(
              (msg.metadata?.analytics as { blocks?: unknown } | undefined)?.blocks,
            ) ? (
              <BlockList
                blocks={(msg.metadata?.analytics as { blocks: AnalyticsBlock[] }).blocks}
