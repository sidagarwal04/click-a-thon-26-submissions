...
import type { AnalyticsBlock, TMessageContentParts } from 'librechat-data-provider';
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                <div className="flex min-h-[20px] max-w-full flex-grow flex-col gap-0">
                  {Array.isArray(
                    (message.metadata?.analytics as { blocks?: unknown } | undefined)?.blocks,
                  ) ? (
                    <BlockList
                      blocks={
                        (message.metadata?.analytics as { blocks: AnalyticsBlock[] }).blocks
                      }
