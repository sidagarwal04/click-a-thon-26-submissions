...
function ChatView({ index = 0, project }: { index?: number; project?: TChatProject }) {
  ...
  const isReportView = Boolean(selectedReportId);

  if (isReportView && selectedReportId) {
    content = <ReportView reportId={selectedReportId} />;
          ...
          <Presentation>
            <div className="relative flex h-full w-full flex-col">
              ...
              <>
                ...
                {isLandingPage && !isReportView && <Footer />}
              </>
            </div>
          </Presentation>
