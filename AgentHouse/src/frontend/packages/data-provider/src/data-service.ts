...
/** Persist a message (and upsert its conversation via saveConvo on the server). */
export function saveConversationMessage(
  ...
  return request.post(endpoints.messages({ conversationId }), {
    ...message,
    conversationId,
  });
}
...
export function queryAnalytics(
  payload: import('./analytics').AnalyticsQueryRequest,
): Promise<import('./analytics').AnalyticsResponse> {
  return request.post(endpoints.analyticsQuery(), payload);
}

export function fetchAnalyticsData(
  payload: import('./analytics').AnalyticsDataRequest,
): Promise<import('./analytics').AnalyticsDataResponse> {
  return request.post(endpoints.analyticsData(), payload);
}

export function fetchAnalyticsDimensions(
  payload: import('./analytics').AnalyticsDimensionsRequest,
): Promise<import('./analytics').AnalyticsDimensionsResponse> {
  return request.post(endpoints.analyticsDimensions(), payload);
}

/** Upsert conversation + messages for an analytics turn (bypasses messages 404-on-new). */
export function persistAnalyticsConversation(
  payload: import('./analytics').AnalyticsPersistRequest,
): Promise<import('./analytics').AnalyticsPersistResponse> {
  return request.post(endpoints.analyticsPersist(), payload);
}
