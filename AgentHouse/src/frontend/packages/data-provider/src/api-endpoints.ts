...
/* Analytics */
export const analyticsQuery = () => `${BASE_URL}/api/analytics/query`;
export const analyticsData = () => `${BASE_URL}/api/analytics/data`;
export const analyticsDimensions = () => `${BASE_URL}/api/analytics/dimensions`;
export const analyticsPersist = () => `${BASE_URL}/api/analytics/persist`;
